...
| `xdm:propositions.xdm:activity` | The schema for an activity. This contains the unique identifier for an offer activity. | `"xdm:id": "xcore:activity:ffed0123"` |
| `xdm:propositions.xdm:placement` | The schema for a placement. This contains the unique identifier for an offer placement. | `"xdm:id": "xcore:placement:ffed0456"` |
